...
template<int N>
pt_element clear_pte(hw_ptep<N> ptep)
{
...
template<int N>
bool clear_accessed(hw_ptep<N> ptep)
{
...
template<int N>
bool clear_dirty(hw_ptep<N> ptep)
{
...
template<int N>
bool write_pte(void *addr, hw_ptep<N> ptep, pt_element pte)
{
